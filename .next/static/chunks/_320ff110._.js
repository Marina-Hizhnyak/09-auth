...
function Pagination(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Pagination$2f$Pagination$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].paginationContainer,
...
async function fetchNotes(param) {
    let { page, perPage, search, tag } = param;
    const params = {
        page,
        perPage
    };
...
async function deleteNote(noteId) {
    const response = await client.delete("/notes/".concat(noteId));
    return response.data;
}
async function fetchNoteById(id) {
    const { data } = await client.get("/notes/".concat(id));
    return data;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
function NotesClient(param) {
    let { initialSearch, initialPage, perPage, tag } = param;
    _s();
    const [search, setSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialSearch !== null && initialSearch !== void 0 ? initialSearch : '');
    const [currentPage, setCurrentPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialPage !== null && initialPage !== void 0 ? initialPage : 1);
...
_s(NotesClient, "JitB6YVXGLNd3+9EKy5RSG4yecQ=", false, function() {
    return [
...
//# sourceMappingURL=_320ff110._.js.map